...
<html lang="en">
<head>
    <title>Code coverage report for lib/oauth/authenticator.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">lib/oauth/</a> authenticator.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    ...
    switch (req.body.grant_type) {
      ...
      case 'stormpath_token':
        ...
        break;
<span class="branch-4 cbranch-no" title="branch not covered" >      case 'client_credentials':</span>
<span class="cstat-no" title="statement not covered" >        authenticator = new OAuthClientCredentialsAuthenticator(this.application);</span>
<span class="cstat-no" title="statement not covered" >        break;</span>
<span class="branch-5 cbranch-no" title="branch not covered" >      case 'stormpath_social':</span>
<span class="cstat-no" title="statement not covered" >        authenticator = new OAuthStormpathSocialAuthenticator(this.application);</span>
    }
  }
&nbsp;
  if (authenticator) {
