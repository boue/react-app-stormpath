...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">lib/</a> Client.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">80.83% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>156/193</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">69.49% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>41/59</span>
      </div>
      <div class='fl pad1y space-right2'>
...
1206
1207
1208</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">31×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1488×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">31×</span>
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (utils.isConfigLoader(config)) {
<span class="cstat-no" title="statement not covered" >    configLoader = config;</span>
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!utils.isValidHref(args.href, '/accessTokens/')) {
<span class="cstat-no" title="statement not covered" >    return args.callback(new InvalidHrefError(args.href, 'Access Token'));</span>
  }
&nbsp;
  return this.getResource(args.href, args.options, require('./resource/AccessToken'), args.callback);
};
&nbsp;
Client.prototype.getApiKeyById = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  var args = utils.resolveArgs(arguments, ['id', 'options', 'callback']);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var href = this.config.client.baseUrl + '/apiKeys/' + args.id;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return this.getResource(href, args.options, require('./resource/ApiKey'), args.callback);</span>
};
&nbsp;
/**
...
Client.prototype.getRefreshToken = function() {
  var args = utils.resolveArgs(arguments, ['href', 'options', 'callback']);
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!utils.isValidHref(args.href, '/refreshTokens/')) {
<span class="cstat-no" title="statement not covered" >    return args.callback(new InvalidHrefError(args.href, 'Refresh Token'));</span>
  }
&nbsp;
 ...
 * });
 */
Client.prototype.createApplications = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  var args = utils.resolveArgs(arguments, ['apps', 'options', 'callback']);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  this.getCurrentTenant(<span class="fstat-no" title="function not covered" >function(err, tenant) {</span></span>
<span class="cstat-no" title="statement not covered" >    if (err) {</span>
<span class="cstat-no" title="statement not covered" >      return args.callback(err);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    async.map(args.apps, <span class="fstat-no" title="function not covered" >function(app, cb) {</span></span>
<span class="cstat-no" title="statement not covered" >      return tenant.createApplication(app, args.options, cb);</span>
    }, <span class="fstat-no" title="function not covered" >function(err, applications) {</span>
<span class="cstat-no" title="statement not covered" >      return args.callback(err, applications);</span>
    });
  });
};
&nbsp;
 ...
 * });
 */
Client.prototype.createDirectories = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  var args = utils.resolveArgs(arguments, ['dirs', 'options', 'callback']);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  this.getCurrentTenant(<span class="fstat-no" title="function not covered" >function(err, tenant) {</span></span>
<span class="cstat-no" title="statement not covered" >    if (err) {</span>
<span class="cstat-no" title="statement not covered" >      return args.callback(err);</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    async.map(args.dirs, <span class="fstat-no" title="function not covered" >function(dir, cb) {</span></span>
<span class="cstat-no" title="statement not covered" >      return tenant.createDirectory(dir, args.options, cb);</span>
    }, <span class="fstat-no" title="function not covered" >function(err, directories) {</span>
<span class="cstat-no" title="statement not covered" >      return args.callback(err, directories);</span>
    });
  });
};
&nbsp;
 ...
 * });
 */
Client.prototype.createSmtpServer = <span class="fstat-no" title="function not covered" >function createSmtpServer() {</span>
<span class="cstat-no" title="statement not covered" >  var args = utils.resolveArgs(arguments, ['server', 'options', 'callback']);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  this.getCurrentTenant(<span class="fstat-no" title="function not covered" >function(err, tenant) {</span></span>
<span class="cstat-no" title="statement not covered" >    if (err) {</span>
<span class="cstat-no" title="statement not covered" >      return args.callback(err);</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return tenant.createSmtpServer(args.server, args.options, args.callback);</span>
  });
};
&nbsp;
/**
...
Client.prototype.getAccount = function() {
  var args = utils.resolveArgs(arguments, ['href', 'options', 'callback']);
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!utils.isValidHref(args.href, '/accounts/')) {
<span class="cstat-no" title="statement not covered" >    return args.callback(new InvalidHrefError(args.href, 'Account'));</span>
  }
&nbsp;
...
Client.prototype.getApplication = function() {
  var args = utils.resolveArgs(arguments, ['href', 'options', 'callback']);
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!utils.isValidHref(args.href, '/applications/')) {
<span class="cstat-no" title="statement not covered" >    return args.callback(new InvalidHrefError(args.href, 'Application'));</span>
  }
&nbsp;
...
Client.prototype.getDirectory = function() {
  var args = utils.resolveArgs(arguments, ['href', 'options', 'callback']);
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!utils.isValidHref(args.href, '/directories/')) {
<span class="cstat-no" title="statement not covered" >    return args.callback(new InvalidHrefError(args.href, 'Directory'));</span>
  }
&nbsp;
...
Client.prototype.getGroup = function() {
  var args = utils.resolveArgs(arguments, ['href', 'options', 'callback']);
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!utils.isValidHref(args.href, '/groups/')) {
<span class="cstat-no" title="statement not covered" >    return args.callback(new InvalidHrefError(args.href, 'Group'));</span>
  }
&nbsp;
...
Client.prototype.getGroupMembership = function() {
  var args = utils.resolveArgs(arguments, ['href', 'options', 'callback']);
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!utils.isValidHref(args.href, '/groupMemberships/')) {
<span class="cstat-no" title="statement not covered" >    return args.callback(new InvalidHrefError(args.href, 'Group Membership'));</span>
  }
&nbsp;
...
&nbsp;
  return this.getCurrentTenant(function onGetCurrentTenantForGroups(err, tenant) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (err) {
<span class="cstat-no" title="statement not covered" >      return args.callback(err, null);</span>
    }
 ...
 * });
 */
Client.prototype.getSmtpServers = <span class="fstat-no" title="function not covered" >function getSmtpServers(/* [options,] callback */) {</span>
<span class="cstat-no" title="statement not covered" >  var args = utils.resolveArgs(arguments, ['options', 'callback'], true);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return this.getCurrentTenant(<span class="fstat-no" title="function not covered" >function onGetCurrentTenant(err, tenant) {</span></span>
<span class="cstat-no" title="statement not covered" >    if (err) {</span>
<span class="cstat-no" title="statement not covered" >      return args.callback(err, null);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return tenant.getSmtpServers(args.options, args.callback);</span>
  });
};
&nbsp;
