...
<html lang="en">
<head>
    <title>Code coverage report for lib/resource/Account.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">lib/resource/</a> Account.js
    </h1>
    <div class='clearfix'>
...
503
504
505</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
Account.prototype.createApiKey = function createApiKey(options, callback) {
  var cb = typeof options === 'function' ? options : <span class="branch-1 cbranch-no" title="branch not covered" >callback;</span>
  var opts = _.extend({}, this.dataStore.apiKeyEncryptionOptions, typeof options === 'object' ? <span class="branch-0 cbranch-no" title="branch not covered" >options </span>: {});
&nbsp;
...
&nbsp;
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (self.customData) {
    var lastArg = args.length &gt; 0 ? args[args.length - 1] : <span class="branch-1 cbranch-no" title="branch not covered" >null;</span>
    var originalCallback = typeof lastArg === 'function' ? args.pop() : <span class="fstat-no" title="function not covered" ><span class="branch-1 cbranch-no" title="branch not covered" >function nop() {</span>};</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >          return originalCallback(err);</span>
        }
&nbsp;
