...
<html lang="en">
<head>
    <title>Code coverage report for lib/resource/CustomData.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">lib/resource/</a> CustomData.js
    </h1>
    <div class='clearfix'>
...
CustomData.prototype.remove = function removeCustomDataField(fieldName){
  <span class="missing-if-branch" title="if path not taken" >I</span>if (fieldName in RESERVED_FIELDS_HREF){
